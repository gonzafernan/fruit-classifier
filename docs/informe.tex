...
Puede observarse como la cantidad de aciertos para este algoritmo es menor que para el algoritmo \textit{K-nn}.
...
\hline
\textbf{K-nn} &  &  & \begin{tabular}[c]{@{}c@{}}Clasificación:\\ 0m 6.387s\\ (Variable con el tamaño\\ de la base de datos)\end{tabular} \\ \cline{1-1} \cline{3-4} 
\textbf{K-means} & \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Análisis de base de datos:\\ 1m 34.254s\end{tabular}} & \begin{tabular}[c]{@{}c@{}}Entrenamiento del algoritmo:\\ 0m 1.279s\\ (Variable con el tamaño\\ de la base de datos)\end{tabular} & \begin{tabular}[c]{@{}c@{}}Clasificación:\\ 0m 0.551s\end{tabular} \\ \hline
\end{tabular}
\caption{Comparación del tiempo de ejecución de algoritmos \textit{K-nn} y \textit{K-means}, en igualdad de condiciones.}
\label{tiempo-ejecucion}
\end{table}

% EJEMPLO DE APLICACIÓN
\section{Ejemplo de aplicación}
A continuación, se muestra como ejemplo la ejecución del proyecto para clasificar una fruta de cada clase, figura \ref{frutas}.
